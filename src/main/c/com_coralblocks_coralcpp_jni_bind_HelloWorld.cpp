...
#include "com_coralblocks_coralcpp_jni_bind_HelloWorld.h"
...
// required for JNI-BIND:
JNIEXPORT void JNICALL Java_com_coralblocks_coralcpp_jni_1bind_HelloWorld_tearDownJvm
  (JNIEnv *, jclass) {
	jvm = nullptr; // release before exiting the JVM on the Java side...
}

JNIEXPORT void JNICALL Java_com_coralblocks_coralcpp_jni_1bind_HelloWorld_goToNativeSide
